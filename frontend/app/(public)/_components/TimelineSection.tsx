...
const events = [
  ...
  },
  {
    ...
    desc: "Systematic research into options flow, market microstructure, and quantitative alpha generation. Data as signal, not noise.",
    tag: "Research",
    accent: "#fb923c",
    ch: "04",
  },
  {
    ...
    desc: "Real-time options platform with live data feeds, backtesting engine, and signal dashboards. Still uncertain — productively.",
    tag: "Launch",
    accent: "var(--color-terminal-green)",
    ch: "05",
  },
