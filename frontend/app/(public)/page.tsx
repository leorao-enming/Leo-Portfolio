    ...
    <div className="py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <ScrollReveal delay={0} direction="up">
          <TiltCard
            intensity={6}
            className="border p-8 rounded-sm flex flex-col min-h-[420px] justify-between h-full"
            style={{ ...cardBase, border: "1px solid #3f3f46" }}
          >
            <div>
        ...
        <ScrollReveal delay={60} direction="up">
          <TiltCard
            className="border p-8 rounded-sm flex flex-col h-full"
            style={{ ...cardBase, border: "1px solid #3f3f46" }}
          >
            ...
            <p className="text-base font-semibold mb-1 text-white">Chemical Engineering</p>
            <p className="text-xs mb-4 text-zinc-400">University of Toronto</p>
            <div
          ...
          >
            ...
            <div className="font-mono text-xs flex-1">
              {STACK.map((item, i) => (
                ...
                >
                  <span className="w-16 shrink-0 tracking-wider text-zinc-500">{item.key}</span>
                  <span className={item.key === "STATUS" ? "terminal-text" : item.accent ? "tech-accent" : "text-zinc-200"}>
                    {item.val}
                  </span>
                </div>
              ))}
        ...
        <ScrollReveal delay={80} direction="up">
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                <p className="text-base font-semibold mb-1 text-white">Six Sigma Black Belt</p>
            ...
            <div className="h-px mb-4" style={{ background: "linear-gradient(to right, rgba(255,176,0,0.35), transparent)" }} />
          ...
          >
            ...
            <div className="space-y-0 flex-1">
              {TECHNICAL_ARSENAL.map((item, i) => (
                ...
                >
                  <span className="text-xs tracking-wider text-zinc-500">{item.key}</span>
        ...
        {/* ── [F] REGISTERED SUBSYSTEMS — 2 cols ── */}
        <div className="lg:col-span-2">
          <ScrollReveal delay={100} direction="up">
            <TiltCard
              intensity={5}
              className="border p-6 rounded-sm flex flex-col h-full"
              style={{ ...cardBase, border: "1px solid #3f3f46" }}
            >
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold tracking-wider text-zinc-100">{sys.label}</span>
                      </div>
                    ...
                    <p className="text-xs leading-relaxed flex-1 text-zinc-300">{sys.description}</p>
        ...
        {/* ── [H] HALF-LIFE SIMULATOR — 2 cols ── */}
        <div className="lg:col-span-2">
          <ScrollReveal delay={60} direction="left">
            <TiltCard
              intensity={4}
              className="border p-6 rounded-sm flex flex-col h-full"
              style={{ ...cardActive, border: "1px solid #52525b" }}
            >
